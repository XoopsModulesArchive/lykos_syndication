...
$filename = '../cache/lykos_reviews.rss';      //File to read/write
...
if ($fd and (time() - filemtime($filename) < $timespan)) {
    ...
    if (!$result) {
        ...
        $temp .= '       <title>' . $xoopsConfig['sitename'] . " - Reviews </title>\n";

        $temp .= '       <link>' . XOOPS_URL . "/modules/lykos_reviews</link>\n";
        ...
        while ($myrow = $xoopsDB->fetchArray($result)) {
            ...
            $temp .= '       <title>' . htmlspecialchars($myrow['review_title'], ENT_QUOTES | ENT_HTML5) . '' . htmlspecialchars($myrow['review_item'], ENT_QUOTES | ENT_HTML5) . "</title>\n";

            $temp .= '       <link>' . XOOPS_URL . '/modules/lykos_reviews/index.php?op=r&cat_id=' . htmlspecialchars($myrow['category_id'], ENT_QUOTES | ENT_HTML5) . '&rev_id=' . htmlspecialchars($myrow['review_id'], ENT_QUOTES | ENT_HTML5) . "</link>\n";

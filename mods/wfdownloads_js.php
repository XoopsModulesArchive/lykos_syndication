...
if ($fd and (time() - filemtime($filename) < $timespan)) {
    ...
    if (!$result) {
        ...
        $temp .= '<a href="' . XOOPS_URL . '/modules/wfdownloads">' . $xoopsConfig['sitename'] . " - Téléchargements</a><br></div>');\n";
        ...
        while ($myrow = $xoopsDB->fetchArray($result)) {
            ...
            $temp .= "document.write('* <span class=\"rss_body\"><A HREF=\"" . XOOPS_URL . '/modules/wfdownloads/singlefile.php?cid=' . htmlspecialchars($myrow['lid'], ENT_QUOTES | ENT_HTML5) . '&amp;lid=' . htmlspecialchars($myrow['lid'], ENT_QUOTES | ENT_HTML5) . '">';
